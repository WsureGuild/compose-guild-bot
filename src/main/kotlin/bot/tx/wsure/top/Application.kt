    ...
    embeddedServer(Netty, port = 8080, host = "0.0.0.0") {
        ...
        val scConfig = mutableMapOf<String, List<Pair<Long, Long>>>(
            "21452505" to listOf(
                ...
                36667731636792997 to 1384516,// 七海  阿梓七海子频
            ),
            "510" to listOf(
                6000051636714649 to 1454836,// 阿梓 七海频道 火车站子频
                36667731636792997 to 1365148,// 阿梓 阿梓 直播讨论
            ),
            "213" to listOf(6000051636714649 to 1454836), // C酱 七海频道 火车站子频
            "876396" to listOf(6000051636714649 to 1454836), // 忘了是谁了  七海频道 火车站子频
            "22047448" to listOf(6000051636714649 to 1454836), // 星宮汐Official 七海频道 火车站子频
            "21402309" to listOf(6000051636714649 to 1454836), // 眞白花音_Official 七海频道 火车站子频
            "14327465" to listOf(6000051636714649 to 1454836), // 花园Serena 七海频道 火车站子频
        )
