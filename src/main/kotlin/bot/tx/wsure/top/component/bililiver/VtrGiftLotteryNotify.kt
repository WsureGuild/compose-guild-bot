...
class VtrGiftLotteryNotify(val config:List<ChannelConfig>, val sender: UnofficialMessageSender): BiliLiverEvent() {
    ...
    override fun onVtrGiftLottery(vtrGiftLottery: VtrGiftLottery) {
